...
<html>
    ...
    <body>
        <div class="header">
            <h1'>ica02- <?php echo "ICA03 - Welcome {$_SESSION['username']}, {$_SESSION['userID']}" ?></h1>
        </div>
        <div class="main">
            <table id="ica2tbl">
                <tr><td><a href="settings.php">Settings</a></td><td><a href="messages.php">Messages</a></td></tr>
                <tr><td><a href="index.php">Tag Admin</a></td><td><a href="RTData.php">RT Monitor</a></td></tr>
