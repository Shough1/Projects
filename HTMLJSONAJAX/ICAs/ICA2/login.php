...
<html>
    ...
    <body>
        <div class='header'><h2>ICA02 - Login - Shawn Hough</h2></div>
        <div class='main'>
            <form action='login.php' method='post'>
                <table id='ica2tbl'>
                    <tbody>
                        <tr>
                            <td>UserName:</td><td><input type='text' placeholder='Supply a username' Name='username'><td>(admin)</td></td>
                        </tr>
                        <tr>
                            <td>Password:</td><td><input type='password' placeholder="Supply your password" Name='password'><td>(god)</td></td>
                        </tr>
                        <tr>
